...
import com.diyaddinkilic.fotografpaylasmafirebase.databinding.ActivityMainBinding
    ...
    fun girisYap(view: View) {
        auth.signInWithEmailAndPassword(
            ...
            if (task.isSuccessful) {
                ...
                Toast.makeText(this, "Hoş Geldiniz $guncelKullanici", Toast.LENGTH_LONG).show()
